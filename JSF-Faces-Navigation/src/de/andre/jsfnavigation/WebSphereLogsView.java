...
public final class WebSphereLogsView
    ...
    private void createToolbar(
        ...
        wordWrapButton.setText(
                "Wrap");

        wordWrapButton.setToolTipText(
                "Wrap long log lines instead of scrolling horizontally");

        wordWrapButton.setSelection(
                store != null
                && store.getBoolean(
                        WebSphereLogSettings.WORD_WRAP));

        wordWrapButton.addSelectionListener(
                new SelectionAdapter() {
                    @Override
                    public void widgetSelected(
                            SelectionEvent e) {
        ...
        rules.setToolTipText(
                "Configure persistent ignore rules for recurring log messages");

        rules.addSelectionListener(
                new SelectionAdapter() {
                    @Override
                    public void widgetSelected(
                            SelectionEvent e) {
    ...
    private String filtered(
        ...
        String source =
                WebSphereLogFilterRules.apply(
                        raw,
                        configuredIgnoreRules());
    ...
    private String configuredIgnoreRules() {
        IPreferenceStore store =
                WebSphereHotSyncSettings.store();
        ...
        return store == null
                ? ""
                : store.getString(
                        WebSphereLogSettings.IGNORE_RULES);
    }
    ...
    private void applyWordWrapToAll(
            boolean enabled) {
    ...
    private void editFilterRules() {
        ...
        WebSphereLogFilterRulesDialog dialog =
                new WebSphereLogFilterRulesDialog(
                        getSite().getShell(),
                        current);

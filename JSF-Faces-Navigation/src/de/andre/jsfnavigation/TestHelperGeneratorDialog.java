...
public final class TestHelperGeneratorDialog
    ...
    protected Control createDialogArea(
        ...
        selected.setText(
                ...
                + (analysis.getFixtureDependencies()
                        .size() == 1
                                ? " fixture/query dependency"
                                : " fixture/query dependencies")
                + "  •  "
                + targets.size()
                + (targets.size() == 1
        ...
        hint.setText(
                ...
                + "For JPA paths the analyzer also follows query-builder type literals/constructed types and entity relationships to suggest fixture Entities/TOs. "
                + "If no test exists, the plug-in ranks actual Java source roots. Insert is always explicit; detected fixtures are advisory and should be reviewed.");

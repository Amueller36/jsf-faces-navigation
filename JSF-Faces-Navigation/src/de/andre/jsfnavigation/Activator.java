...
public final class Activator extends AbstractUIPlugin {
    ...
    public void start(BundleContext context) throws Exception {
        ...
        JavaTestRunSettings.initializeDefaults(
                getPreferenceStore());
        ...
        /*
         * Do NOT install the save-time impacted-test listener here.  That
         * listener used CallerSearch/SearchEngine after every Java save when
         * "Auto tests" was enabled.  In RAD/WebSphere workspaces this can
         * start JDT internal search jobs (for example "Find Node Job") at
         * exactly the same time as WTP updates its service model, which can
         * make a foreground editor/save operation wait for those jobs.
         *
         * Related-test discovery still happens when a production file is
         * explicitly/newly captured in a Flow.  Expensive caller-impact
         * analysis is no longer part of the normal typing/save path.
         */
    ...
    public void stop(BundleContext context) throws Exception {
        try {
            ...
            JavaTypeFinder.clearCache();
            JdtHierarchyCache.clear();
            JsfTaglibCatalogService.clearCache();
            FlowJavaSemantics.clear();
            FlowTestLaunchSupport.clear();
            FlowRelatedTestDiscoveryService.clearRecentRequests();
    ...
    public static JsfDiagnosticsService getJsfDiagnosticsService() {
        Activator plugin = instance;
        return plugin == null ? null : plugin.jsfDiagnosticsService;
    }

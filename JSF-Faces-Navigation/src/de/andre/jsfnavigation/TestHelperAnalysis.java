...
public final class TestHelperAnalysis {
    ...
    private final List<TestHelperFixtureDependency> fixtureDependencies;
    ...
    public TestHelperAnalysis(
        ...
        this(
                ...
                parameters,
                dependencies,
                Collections.<TestHelperFixtureDependency>emptyList(),
                jpaDetected,
                jpaWriteDetected,
                jpaReadDetected,
                truncated);
    ...
    public TestHelperAnalysis(
        ...
        this.fixtureDependencies =
                Collections.unmodifiableList(
                        new ArrayList<TestHelperFixtureDependency>(
                                fixtureDependencies == null
                                        ? Collections.<TestHelperFixtureDependency>emptyList()
                                        : fixtureDependencies));
    ...
    public List<TestHelperFixtureDependency> getFixtureDependencies() {
